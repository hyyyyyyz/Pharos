...
class Packaging {
	...
	parseMetadata(xml){
		...
		let writingModeMeta = xml.querySelector("meta[name='primary-writing-mode']");
		metadata.primary_writing_mode = writingModeMeta ? writingModeMeta.getAttribute("content") : "";
