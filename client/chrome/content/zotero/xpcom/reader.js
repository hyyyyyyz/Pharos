...
class ReaderPreview extends ReaderInstance {
	...
	static CSS = {
		...
		/* Pharos: the surround behind every PDF page -- the largest painted area
		   of the reading experience. It lives here, in an injected stylesheet
		   with !important, so no theme file or reader-fork edit can reach it;
		   upstream's #f2f2f2 / #303030 are neutral greys that read as a colour
		   cast against the cream and navy grounds. Values match --c-read in the
		   web client (frontend/src/design/tokens.ts): the desk the sheet lies
		   on, one step deeper than the page ground.

		   The page itself stays pure white -- see --c-sheet. Tinting it would
		   tint every scanned page and figure with it, and a paper's own whites
		...
		@media (prefers-color-scheme: light) {
			...
			.pdfViewer .page::before {
				box-shadow: inset 0 0 0px 1px #0c204021;
			}
		}
