...

{
	...
	class PharosRail extends XULElementBase {
		...
		static MODULES = [
			...
			// The model console: every account configures its own AI
			// conversation provider here. Operators see it too, directly above
			// the admin console -- the two are one settings surface, not
			// alternatives.
			{ key: 'models', icon: 'models', l10n: 'pharos-rail-models' },
